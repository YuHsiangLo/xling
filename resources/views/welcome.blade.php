...
@section('after-body')
    <script>
        const setupPhpPost = (blob, callback) => {
            const filename = 'upload_test_sound.wav';
            const formData = new FormData();
            formData.append('participant_folder', 'upload_test' + '/');
